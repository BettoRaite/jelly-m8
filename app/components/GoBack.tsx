  ...
  return (
    <Link
      ...
      className={joinClasses(
        ...
        "rounded-lg shadow-lg transition-all duration-300 opacity-70 hover:opacity-100",
        "font-jost font-bold hover:border-opacity-100 text-xs p-2 md:text-[0.97rem] lg:text-lg md:p-2",
        {
